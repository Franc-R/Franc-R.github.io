document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadProjects() {
        const projectFolders = ['Bachelor_Thesis', 'DC-Motor Velocity Control Problem', 'MIMO_Analisys', 'Dynamic_Mode_Decomposition_for_EEG', 'TWSBR', 'Design and Experimental Validation of a UAV Platform', 'drone-bci'];
